...
entry1.place('height' => 25, 'width'  => 180, 'x'   => 200, 'y'   => 10)
label1.place('height' => 25, 'width'  => 180, 'x'   => 10, 'y'   => 10)

entry2.place('height' => 25, 'width'  => 180, 'x'   => 200, 'y'   => 40)
label2.place('height' => 25, 'width'  => 180, 'x'   => 10, 'y'   => 40)

entry3.place('height' => 25, 'width'  => 180, 'x'   => 200, 'y'   => 70)
label3.place('height' => 25, 'width'  => 180, 'x'   => 10, 'y'   => 70)

entry4.place('height' => 25, 'width'  => 180, 'x'   => 200, 'y'   => 100)
label4.place('height' => 25, 'width'  => 180, 'x'   => 10, 'y'   => 100)

entry5.place('height' => 25, 'width'  => 180, 'x'   => 200, 'y'   => 130)
label5.place('height' => 25, 'width'  => 180, 'x'   => 10, 'y'   => 130)

entry6.place('height' => 25, 'width'  => 180, 'x'   => 200, 'y'   => 160)
label6.place('height' => 25, 'width'  => 180, 'x'   => 10, 'y'   => 160)
...
entry1.bind("Key"){
	...
	entry3.value=cifrador.cifrar(txt, des);
	entry4.value=cifrador.invertirTexto(txt)
	entry6.value=cifrador.invertirEnGrupos(txt, agrupacion)
}
